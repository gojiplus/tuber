...
YouTube now tracks ordinary Data API units, search calls, and
video-upload calls in separate default buckets. Google Cloud Console
remains the source of truth; the package counters only estimate requests
made by the current R session.
...
|----|----|----|
| Ordinary list request | 1 Data API unit | [`get_video_details()`](https://gojiplus.github.io/tuber/reference/get_video_details.md) |
| Search request | 1 Search Query call | [`yt_search()`](https://gojiplus.github.io/tuber/reference/yt_search.md) |
| Typical write or delete | 50 Data API units | [`create_playlist()`](https://gojiplus.github.io/tuber/reference/create_playlist.md), [`delete_video()`](https://gojiplus.github.io/tuber/reference/delete_video.md) |
| Caption list, download, insert, update | 50, 200, 400, 450 Data API units | Caption functions |
| Video upload | 1 Video Upload call | [`upload_video()`](https://gojiplus.github.io/tuber/reference/upload_video.md) |

Google’s default allocations are 10,000 Data API units, 100 Search Query
calls, and 100 Video Upload calls per day. These defaults can change or
be increased for a project.
