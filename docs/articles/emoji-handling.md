...
comments$has_emoji <- has_emoji(comments$text_display)

# Count emojis per comment
comments$emoji_count <- count_emojis(comments$text_display)
...
comments$clean_text <- remove_emojis(comments$text_display)
